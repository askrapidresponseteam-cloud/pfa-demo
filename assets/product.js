(function () {
  ...
  function labelPanel() {
    ...
    var rows = [
      ...
      ['Type', product.productType || product.categoryLabel || '—'],
      ...
      ['Seller', 'Paws & Tails (fulfilled by seller)']
    ];
  ...
  function render() {
    ...
    host.innerHTML =
      ...
      '<div class="pd-trust"><ul><li>Secure payment on the seller\'s checkout</li><li>Shipped by Paws &amp; Tails</li><li>PFA order number for tracking</li></ul></div>' +
      labelPanel() +
