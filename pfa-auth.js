...
(function () {
  ...
  var CSS = [
    ...
    ".pfa-au-scrim{position:fixed;inset:0;z-index:1200;background:rgba(8,10,14,.62);-webkit-backdrop-filter:blur(9px) saturate(1.1);backdrop-filter:blur(9px) saturate(1.1);opacity:0;visibility:hidden;transition:opacity .3s cubic-bezier(.2,.6,.2,1),visibility 0s linear .3s}",
    ...
    ".pfa-au-k{font-family:var(--font-s,'Marcellus',Georgia,serif);font-size:11px;letter-spacing:.28em;text-transform:uppercase;color:var(--mut-2,#7A848D);margin:0 0 12px}",
    ".pfa-au h2{font-family:var(--font-d,'Archivo',system-ui,sans-serif);font-weight:900;font-size:26px;line-height:1.1;letter-spacing:-.015em;color:var(--ink,#0E1116);margin:0 0 10px}",
    ".pfa-au-sub{font-family:var(--font-d,'Archivo',system-ui,sans-serif);font-size:14px;line-height:1.55;color:var(--mut,#55606A);margin:0 0 24px}",
    ".pfa-au-btn{width:100%;display:flex;align-items:center;justify-content:center;gap:11px;font-family:var(--font-d,'Archivo',system-ui,sans-serif);font-weight:700;font-size:13px;letter-spacing:.1em;text-transform:uppercase;padding:15px 18px;border:1px solid var(--ink,#0E1116);background:var(--ink,#0E1116);color:#fff;cursor:pointer;line-height:1;transition:background .25s,color .25s,border-color .25s}",
    ".pfa-au-btn:hover{background:var(--blue,#00A4FF);border-color:var(--blue,#00A4FF);color:var(--ink,#0E1116)}",
    ".pfa-au-btn.ghost{background:0 0;color:var(--ink,#0E1116);border-color:rgba(14,17,22,.2)}",
    ".pfa-au-btn.ghost:hover{border-color:var(--ink,#0E1116);background:0 0;color:var(--ink,#0E1116)}",
    ".pfa-au-btn[disabled]{opacity:.5;cursor:default}",
    ".pfa-au-or{display:flex;align-items:center;gap:14px;margin:18px 0;font-family:var(--font-s,'Marcellus',Georgia,serif);font-size:10px;letter-spacing:.24em;text-transform:uppercase;color:var(--mut-2,#7A848D)}",
    ".pfa-au-or::before,.pfa-au-or::after{content:'';flex:1;height:1px;background:rgba(14,17,22,.11)}",
    ".pfa-au-f{width:100%;height:50px;padding:0 14px;border:1px solid rgba(14,17,22,.18);background:rgba(255,255,255,.7);font-family:var(--font-d,'Archivo',system-ui,sans-serif);font-size:14px;color:var(--ink,#0E1116);margin-bottom:10px}",
    ".pfa-au-f:focus{outline:0;border-color:var(--blue-ink,#006DB3)}",
    ".pfa-au-note{font-family:var(--font-d,'Archivo',system-ui,sans-serif);font-size:12px;line-height:1.5;color:var(--mut-2,#7A848D);margin:20px 0 0}",
    ".pfa-au-guest{margin:22px 0 0;padding-top:18px;border-top:1px solid rgba(14,17,22,.11);font-family:var(--font-d,'Archivo',system-ui,sans-serif);font-size:13px;line-height:1.5;color:var(--mut,#55606A)}",
    ".pfa-au-x{position:absolute;top:12px;right:12px;width:38px;height:38px;border:0;background:0 0;cursor:pointer;color:var(--mut,#55606A);font-size:20px;line-height:1}",
    ".pfa-au-x:hover{color:var(--ink,#0E1116)}",
    ".pfa-au-err{font-family:var(--font-d,'Archivo',system-ui,sans-serif);font-size:13px;color:#B3261E;margin:0 0 12px;display:none}",
    ".pfa-au-err.on{display:block}",
    ".pfa-au-done{font-family:var(--font-d,'Archivo',system-ui,sans-serif);font-size:14px;line-height:1.6;color:var(--ink,#0E1116)}",
