...
/* someone.html anchors every slot crop on the upper third, because that is where
...
/* The essay lived on index.html until v1.292 moved it to its own page;
   these rules moved with the markup they describe. */
const html = fs.readFileSync(`${__dirname}/../someone.html`, 'utf8');
