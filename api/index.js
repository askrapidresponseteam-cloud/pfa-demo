...
const ROUTES = {
  ...
  'visits': './visits.js',
  'wall': './wall.js',
  'field-notes': './field-notes.js',
  'field-note-photo': './field-note-photo.js',
...
const LOADERS = {
  ...
  'field-notes': () => require('../lib/routes/field-notes.js'),
  'field-note-photo': () => require('../lib/routes/field-note-photo.js'),
