...
(function () {
  ...
  var PAGES = [
    ...
    { t: "Partner with PFA", p: "Partner with PFA", u: CSR + "#top", s: "Corporate partnership. Campaigns you can put your name to, gifting with nothing animal in it, and the compliance pack.", k: "brand partnership collaboration cobrand co-brand campaign limited edition corporate csr sponsor partner company companies act schedule vii section 135 two per cent" },
    { t: "Three campaigns you can put your name to", p: "Partner with PFA", u: CSR + "#campaigns", s: "Whose Street, Shot On The Street, The First Hand. A campaign with your name on it, not a logo on a banner.", k: "campaign campaigns brand name film whose street shot on the street first hand sponsor own" },
    { t: "Corporate gifting with nothing animal in it", p: "Partner with PFA", u: CSR + "#campaigns", s: "No leather, no silk, no wool. Every unit funds rescue, and an impact receipt goes in every box.", k: "gifting gifts diwali corporate hampers kit leather silk wool vegan impact receipt employee desks second budget" },
    { t: "Compliance and registrations", p: "Partner with PFA", u: CSR + "#proof", s: "Schedule VII item (iv), CSR-1, 12A, 80G, FCRA, Darpan, audited financials and the Board Report annexure.", k: "compliance csr-1 csr1 12a 80g fcra darpan registration audited financials schedule vii section 135 board report annexure eligible mca diligence" },
    { t: "The corporate partnerships desk", p: "Partner with PFA", u: CSR + "#contact", s: "A named person who is accountable for everything promised, not a shared inbox.", k: "contact desk partnership corporate talk email phone person accountable" },
