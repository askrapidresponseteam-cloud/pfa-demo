...
".pfa-sbar{display:flex;align-items:center;gap:14px;padding:18px 22px;border-bottom:1px solid rgba(255,255,255,.14);flex:none}",
".pfa-sq{width:10px;height:10px;background:#00A4FF;flex:none}",
".pfa-sbar input{flex:1;border:0;outline:0;font-family:'Archivo',system-ui,sans-serif;font-size:17px;color:#F4F6F7;background:0 0;min-width:0}",
".pfa-sbar input::placeholder{color:#6E7883}",
".pfa-esc{border:1px solid rgba(255,255,255,.14);background:0 0;font-family:inherit;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#6E7883;padding:7px 10px;cursor:pointer;flex:none}",
".pfa-esc:hover{border-color:#F4F6F7;color:#F4F6F7}",
".pfa-results{overflow-y:auto;overscroll-behavior:contain;-webkit-overflow-scrolling:touch}",
".pfa-group{font-family:'Marcellus',Georgia,serif;font-size:10px;letter-spacing:.24em;text-transform:uppercase;color:#6E7883;padding:16px 22px 8px;border-top:1px solid rgba(255,255,255,.08)}",
...
".pfa-res.on,.pfa-res:hover{background:#12161C;border-left-color:#00A4FF}",
".pfa-rtop{display:flex;align-items:baseline;justify-content:space-between;gap:16px}",
".pfa-rt{font-size:15px;font-weight:600;color:#F4F6F7;line-height:1.3}",
".pfa-rp{font-size:10px;letter-spacing:.16em;text-transform:uppercase;color:#6E7883;flex:none;white-space:nowrap;max-width:45%;overflow:hidden;text-overflow:ellipsis}",
".pfa-rs{font-size:13px;color:#8B959E;margin-top:3px;line-height:1.45;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical}",
".pfa-res mark{background:#005CAD;color:inherit;font-weight:600}",
".pfa-empty{padding:44px 22px;text-align:center;color:#8B959E;font-size:14px}",
".pfa-empty b{display:block;font-size:16px;color:#F4F6F7;margin-bottom:6px}",
".pfa-hintrow{display:flex;flex-wrap:wrap;gap:8px;justify-content:center;margin-top:20px}",
".pfa-hint{border:1px solid rgba(255,255,255,.14);padding:11px 15px;font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#8B959E;cursor:pointer;background:#0E1116;font-family:inherit}",
".pfa-hint:hover{border-color:#5BC4FF;color:#5BC4FF}",
".pfa-sect{display:flex;align-items:center;justify-content:space-between;gap:14px;font-family:inherit;font-size:10px;letter-spacing:.24em;text-transform:uppercase;color:#6E7883;text-align:left;margin-bottom:12px}",
".pfa-clear{background:0 0;border:0;cursor:pointer;font-family:inherit;font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#6E7883;padding:8px 0 8px 12px}",
".pfa-clear:hover{color:#F4F6F7}",
".pfa-hintrow.left{justify-content:flex-start;margin-bottom:26px;margin-top:0}",
".pfa-dym{display:block;margin:14px auto 0;background:0 0;border:1px solid #5BC4FF;color:#5BC4FF;cursor:pointer;font-family:inherit;font-size:13px;padding:11px 16px}",
".pfa-dym:hover{background:#12161C}",
".pfa-foot{display:flex;gap:18px;padding:12px 22px;border-top:1px solid rgba(255,255,255,.14);font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#6E7883;flex-wrap:wrap;flex:none}",
/* the visible bar in the nav */
".pfa-searchbar{flex:1 1 auto;display:flex;align-items:center;gap:10px;min-width:0;max-width:400px;height:42px;padding:0 14px;background:#12161C;border:1px solid rgba(255,255,255,.08);cursor:text;transition:border-color .2s ease,background .2s ease}",
".pfa-searchbar:hover{border-color:rgba(255,255,255,.22);background:#0E1116}",
".pfa-searchbar input{flex:1 1 auto;width:auto;min-width:0;height:100%;margin:0;padding:0;border:0;outline:0;background:0 0;box-shadow:none;-webkit-appearance:none;appearance:none;font-family:inherit;font-size:13px;line-height:normal;color:#F4F6F7;cursor:text}",
".pfa-searchbar input:focus{border:0;outline:0;box-shadow:none;background:0 0}",
".pfa-searchbar input::placeholder{color:#6E7883}",
".pfa-searchbar kbd{flex:none;font-family:inherit;font-size:10px;letter-spacing:.06em;color:#6E7883;border:1px solid rgba(255,255,255,.14);padding:3px 6px;background:#0E1116}",
".pfa-searchbar .pfa-mag{flex:none;color:#6E7883}",
".pfa-sicon{display:none;flex:none;width:44px;height:44px;align-items:center;justify-content:center;background:0 0;border:1px solid rgba(255,255,255,.14);cursor:pointer;color:#F4F6F7}",
".pfa-sicon:hover{border-color:#F4F6F7}",
...
"@keyframes pfaFlash{0%,100%{background:transparent}18%{background:#005CAD}}"
].join("");
